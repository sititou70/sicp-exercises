...
; utils
(define 
  (append-instruction-sequences . seqs)
...
(define 
  (verbose-preserving regs seq1 seq2)
  (if (null? regs) 
    (append-instruction-sequences seq1 seq2)
    (let 
      ( ;
...
(define 
  ...
  (set! preserving verbose-preserving)
)

(define 
  (tack-on-instruction-sequence seq body-seq)
  (make-instruction-sequence 
...
(define 
  (parallel-instruction-sequences seq1 seq2)
  (make-instruction-sequence 
    (list-union 
      (registers-needed seq1)
      (registers-needed seq2)

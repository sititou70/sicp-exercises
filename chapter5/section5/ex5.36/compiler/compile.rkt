...
(define 
  (construct-arglist-alt operand-codes)
  (if (null? operand-codes) 
    (make-instruction-sequence 
      '()
      '(argl)
...
(define 
  (code-to-get-rest-args-alt operand-codes)
  (let 
    ( ;
     (code-for-next-arg 
       (preserving 
...
(define 
  ...
  (set! construct-arglist construct-arglist-alt)
  (set! code-to-get-rest-args code-to-get-rest-args-alt)
)

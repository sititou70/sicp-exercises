...
(define 
  ...
  (end-with-linkage 
    ...
    (make-instruction-sequence 
      ...
      `
      ( ;
       (assign ,target (op lookup_variable_value) (const ,exp) (reg env))
      )
    )
  )
)
    ...
    (end-with-linkage 
      ...
      (preserving 
        ...
        (make-instruction-sequence 
          ...
          `
          ( ;
           (perform (op set_variable_value) (const ,var) (reg val) (reg env))
    ...
    (end-with-linkage 
      ...
      (preserving 
        ...
        (make-instruction-sequence 
          ...
          `
          ( ;
           (perform (op define_variable) (const ,var) (reg val) (reg env))
           (assign ,target (const ok))
          )
        )
      )
...
(define 
  ...
  (let 
    ( ;
     (t-branch (make-label 'true_branch))
...
(define 
  ...
  (let 
    ( ;
     (primitive-branch (make-label 'primitive_branch))
...
(define 
  ...
  (cond 
    ...
    ((and 
     ...
     (let 
       ( ;
        (proc-return (make-label 'proc_return))
       )

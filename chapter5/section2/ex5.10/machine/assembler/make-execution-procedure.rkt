  ...
  (let 
    ( ;
     (first-reg 
       (get-register 
         machine
         (swap-first-register inst)
       )
     )
     (second-reg 
       (get-register 
         machine
         (swap-second-register inst)
       )
     )
    )
    ...
    (lambda () 
      (let 
        ( ;
         (first-val (get-contents first-reg))
         (second-val (get-contents second-reg))
        )

        (set-contents! first-reg second-val)
        (set-contents! second-reg first-val)
        (advance-pc pc)
      )
    )
  )

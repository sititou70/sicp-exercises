      ...
      ( ;
       (the-ops 
         (list 
           ...
           (list 
             'print-and-reset-exec-counter
             (lambda () 
               (displayln execution-counter)
           ...
           (list 
             'trace-on
             (lambda () 
               (set! execution-tracing true)
             )
           )
           (list 
             'trace-off
             (lambda () 
               (set! execution-tracing false)
             )
           )
         )
       )
      ...
      (define 
        ...
        (let 
          ...
          (if (null? insts) 
            'done
            (begin 
              (if execution-tracing (displayln (caar insts)))

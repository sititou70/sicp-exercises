...
(define 
  ...
  (let 
    ...
    ((machine 'add-meta-register-sources) 
...
(define 
  ...
  (let 
    ...
    (cond 
      ...
      ((register-exp? dest)
       ((machine 'add-meta-registers-has-entry-point) (register-exp-reg dest))
       (let 
         ( ;
          (reg 
            (get-register 
...
(define 
  ...
  (let 
    ...
    ((machine 'add-meta-stacking-registers) (stack-inst-reg-name inst))
    (lambda () 

...
(clear-canvas)
((flip-vert wave-painter) canvas-frame)
(save-image canvas "ex2.50.flip-vert.png")

(clear-canvas)
((flip-horiz wave-painter) canvas-frame)
(save-image canvas "ex2.50.flip-horiz.png")

(clear-canvas)
((rotate-180 wave-painter) canvas-frame)
(save-image canvas "ex2.50.rotate-180.png")

(clear-canvas)
((rotate-90 wave-painter) canvas-frame)
(save-image canvas "ex2.50.rotate-90.png")

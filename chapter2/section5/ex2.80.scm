...
(=zero? '(scheme-number . 0))
; #t
(=zero? '(scheme-number . 1))
; #f
...
(=zero? '(complex rectangular 0 . 0))
; #t
(=zero? '(complex rectangular 1 . 0))
; #f
(=zero? '(complex rectangular 0 . 1))
; #f
(=zero? '(complex rectangular 1 . 1))
; #f

(=zero? '(complex polar 0 . 0))
; #t
(=zero? '(complex polar 0 . 123))
; #t
(=zero? '(complex polar 1 . 123))
; #f

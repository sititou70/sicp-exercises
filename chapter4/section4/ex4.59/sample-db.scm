...
(define 
  ...
  (repl '(assert! (meeting accounting (Monday 9am))))
  (repl '(assert! (meeting administration (Monday 10am))))
  (repl '(assert! (meeting computer (Wednesday 3pm))))
  (repl '(assert! (meeting administration (Friday 1pm))))
  (repl '(assert! (meeting whole-company (Wednesday 4pm))))
)
